...
import { EscalationBanner } from '@/components/app/escalation-banner';
import { useMossContextEvents } from '@/hooks/useMossContextEvents';
import { useEscalationEvent } from '@/hooks/useEscalationEvent';
...
export function AgentSessionView_01({
  ...
  // Escalation signal — when present, the human can take over via the Agent Desk.
  const escalation = useEscalationEvent();
  ...
  return (
    ...
    >
      ...
      {/* Escalation banner — appears when the agent hands off to a human. */}
      <div className="pointer-events-none absolute inset-x-0 top-0 z-[70] mx-auto w-full max-w-2xl px-4 pt-20">
